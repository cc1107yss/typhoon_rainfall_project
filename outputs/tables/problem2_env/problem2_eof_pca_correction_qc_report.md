...
## 1. 输入输出文件
- 19 号 initial NPZ: `data/processed/problem2_env/problem2_generated_initial_fields_topk_weighted_env.npz`
- 19 号 index: `data/processed/problem2_env/problem2_generated_initial_fields_index_env.csv`
- Top-K 表: `data/processed/problem2_env/problem2_target_topk_similar_history_env.csv`
- EOF/PCA model 输出: `data/processed/problem2_env/problem2_eof_pca_model_env.npz`
- coefficients CSV 输出: `data/processed/problem2_env/problem2_target_eof_coefficients_env.csv`
- blended NPZ 输出: `data/processed/problem2_env/problem2_generated_pca_blended_fields_env.npz`
- blended index CSV 输出: `data/processed/problem2_env/problem2_generated_pca_blended_fields_index_env.csv`
- figures 目录: `outputs/figures/problem2_env/eof_pca_correction`
