...
## 1. 输入输出文件
- Target safe input table: `data/processed/problem2_env/problem2_target_halfhour_inputs_safe_env.csv`
- Top-K retrieval table: `data/processed/problem2_env/problem2_target_topk_similar_history_env.csv`
...
- Step-21 QC report: `outputs/tables/problem2_env/problem2_extreme_calibration_qc_report.md`
- Step-22 model validation summary: `data/processed/problem2_env/pseudo_validation_model_summary_base_old.csv`
- Step-22 event validation summary: `data/processed/problem2_env/pseudo_validation_event_summary_selected.csv`
- Step-22 timeslice validation metrics: `data/processed/problem2_env/pseudo_validation_timeslice_metrics_selected.csv`
- Step-22 QC report: `outputs/tables/problem2_env/pseudo_validation_qc_report_selected.md`
- Final timeseries CSV: `outputs/tables/problem2_env/problem2_final_timeseries_metrics.csv`
- Final summary CSV: `outputs/tables/problem2_env/problem2_final_typhoon_metrics_summary.csv`
- Final key times CSV: `outputs/tables/problem2_env/problem2_final_key_times.csv`
...
## 9. 图件清单
- `outputs/figures/problem2_env/KONG_REY_final_track_intensity_rain_timeseries.png`
- `outputs/figures/problem2_env/MAN_YI_final_track_intensity_rain_timeseries.png`
- `outputs/figures/problem2_env/KONG_REY_final_rain_metrics_timeseries.png`
- `outputs/figures/problem2_env/MAN_YI_final_rain_metrics_timeseries.png`
- `outputs/figures/problem2_env/KONG_REY_final_representative_fields.png`
- `outputs/figures/problem2_env/MAN_YI_final_representative_fields.png`
- `outputs/figures/problem2_env/KONG_REY_final_cumulative_rain_storm_relative.png`
- `outputs/figures/problem2_env/MAN_YI_final_cumulative_rain_storm_relative.png`
- `outputs/figures/problem2_env/KONG_REY_final_max_rain_storm_relative.png`
- `outputs/figures/problem2_env/MAN_YI_final_max_rain_storm_relative.png`
- `outputs/figures/problem2_env/KONG_REY_final_duration10_storm_relative.png`
- `outputs/figures/problem2_env/KONG_REY_final_duration20_storm_relative.png`
- `outputs/figures/problem2_env/MAN_YI_final_duration10_storm_relative.png`
- `outputs/figures/problem2_env/MAN_YI_final_duration20_storm_relative.png`
- `outputs/figures/problem2_env/KONG_REY_final_quadrant_contribution.png`
- `outputs/figures/problem2_env/MAN_YI_final_quadrant_contribution.png`
- `outputs/figures/problem2_env/problem2_final_two_typhoons_timeseries_compare.png`
- `outputs/figures/problem2_env/problem2_final_two_typhoons_summary_compare.png`
- `outputs/figures/problem2_env/problem2_final_validation_model_comparison.png`
