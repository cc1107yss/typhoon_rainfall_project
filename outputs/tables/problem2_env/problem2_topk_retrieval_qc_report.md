...
- 目标路径/安全输入来源: `data/processed/env_added/target_typhoon_inputs_2024_halfhour_leakage_safe_env.csv` (existing_halfhour_safe_input)
- 目标安全输入输出: `data/processed/problem2_env/problem2_target_halfhour_inputs_safe_env.csv`
- Top-K 输出: `data/processed/problem2_env/problem2_target_topk_similar_history_env.csv`
- QC 报告: `outputs/tables/problem2_env/problem2_topk_retrieval_qc_report.md`
