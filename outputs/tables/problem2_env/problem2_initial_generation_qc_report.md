...
## 1. 输入文件与输出文件
- target input: `data/processed/problem2_env/problem2_target_halfhour_inputs_safe_env.csv`
...
- NPZ 输出: `data/processed/problem2_env/problem2_generated_initial_fields_topk_weighted_env.npz`
- index CSV 输出: `data/processed/problem2_env/problem2_generated_initial_fields_index_env.csv`
- figures 输出目录: `outputs/figures/problem2_env/initial_generation`
