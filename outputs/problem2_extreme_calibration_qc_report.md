...
## 1. 输入输出文件
- blended NPZ: `data/processed/problem2_generated_pca_blended_fields.npz`
- blended index: `data/processed/problem2_generated_pca_blended_fields_index.csv`
...
- calibration targets 输出: `data/processed/problem2_extreme_calibration_targets.csv`
- calibrated NPZ 输出: `data/processed/problem2_generated_calibrated_fields.npz`
- calibrated index 输出: `data/processed/problem2_generated_calibrated_fields_index.csv`
- figures 目录: `outputs/figures/problem2_extreme_calibration`
