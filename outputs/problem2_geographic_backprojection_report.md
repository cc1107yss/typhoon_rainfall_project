...
- final timeseries: `data/processed/problem2_final_timeseries_metrics.csv`
- final summary: `data/processed/problem2_final_typhoon_metrics_summary.csv`
- final key times: `data/processed/problem2_final_key_times.csv`
- geographic NPZ: `data/processed/problem2_final_geographic_fields.npz`
- geographic summary CSV: `data/processed/problem2_final_geographic_summary.csv`
- geographic key locations CSV: `data/processed/problem2_final_geographic_key_locations.csv`
- geographic timeseries metrics CSV: `data/processed/problem2_final_geographic_timeseries_metrics.csv`
- figures directory: `outputs/figures/problem2_geographic_results`
...
- `outputs/figures/problem2_geographic_results/KONG_REY_final_cumulative_rain_geographic.png`
- `outputs/figures/problem2_geographic_results/KONG_REY_final_duration10_geographic.png`
- `outputs/figures/problem2_geographic_results/KONG_REY_final_max_rain_geographic.png`
- `outputs/figures/problem2_geographic_results/KONG_REY_final_duration20_geographic.png`
- `outputs/figures/problem2_geographic_results/MAN_YI_final_cumulative_rain_geographic.png`
- `outputs/figures/problem2_geographic_results/MAN_YI_final_duration10_geographic.png`
- `outputs/figures/problem2_geographic_results/MAN_YI_final_max_rain_geographic.png`
- `outputs/figures/problem2_geographic_results/MAN_YI_final_duration20_geographic.png`
- `outputs/figures/problem2_geographic_results/problem2_geo_cumulative_compare.png`
- `outputs/figures/problem2_geographic_results/problem2_geo_duration10_compare.png`
